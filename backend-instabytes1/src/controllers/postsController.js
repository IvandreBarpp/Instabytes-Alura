...
export async function listarPosts (req, res) {
  ...
  // Chama a função assíncrona para obter todos os posts.
  res.status(200).json(posts);
  // Envia uma resposta HTTP com status 200 (sucesso) e o corpo da resposta contendo os posts em formato JSON.
}
